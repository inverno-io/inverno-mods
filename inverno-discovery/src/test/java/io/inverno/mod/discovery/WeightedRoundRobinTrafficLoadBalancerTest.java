 ...
 */
public class WeightedRoundRobinTrafficLoadBalancerTest {
	...
	public void test() {
		...
		TrafficLoadBalancer<WeightedServiceInstance, Object> lb = new WeightedRoundRobinTrafficLoadBalancer<>(List.of(instance1, instance2, instance3));
		...
		Assertions.assertEquals(15000, count1);
		Assertions.assertEquals(30000, count2);
		Assertions.assertEquals(45000, count3);
	}
	...
	public void test_concurrent() throws InterruptedException {
		...
		// Let's consider 1% delta proves the point
		Assertions.assertEquals(160000, count1.get());
		Assertions.assertEquals(320000, count2.get());
