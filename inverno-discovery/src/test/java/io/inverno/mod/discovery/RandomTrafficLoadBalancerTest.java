 ...
 */
public class RandomTrafficLoadBalancerTest {
	...
	public void test() {
		...
		TrafficLoadBalancer<ServiceInstance, Object> lb = new RandomTrafficLoadBalancer<>(List.of(instance1, instance2, instance3));
		...
		Assertions.assertEquals(300000, count1, 300000*0.01);
		Assertions.assertEquals(300000, count2, 300000*0.01);
		Assertions.assertEquals(300000, count3, 300000*0.01);
	}
	...
	public void test_concurrent() throws InterruptedException {
		...
		// Let's consider 1% delta proves the point
		Assertions.assertEquals(320000, count1.get(), 320000*0.01);
		Assertions.assertEquals(320000, count2.get(), 320000*0.01);
		Assertions.assertEquals(320000, count3.get(), 320000*0.01);
	}
}
