...
public class StringValueDecoder implements ValueDecoder<String> {
	...
	@Override
	public <T> T to(String value, Class<T> type) throws ValueCodecException {
	...
	public Byte toByte(String value) throws ValueCodecException {
		try {
			...
			throw new ValueCodecException(value + " can't be decoded to the requested type", e);
		}
	}
	...
	public Character toCharacter(String value) throws ValueCodecException {
		...
		throw new ValueCodecException(value + " can't be decoded to the requested type");
	}
	...
	public LocalDate toLocalDate(String value) throws ValueCodecException {
		try {
			return LocalDate.parse(StringEscapeUtils.unescapeJava(value));
		} 
		catch (Exception e) {
			throw new ValueCodecException(value + " can't be decoded to the requested type", e);
		}
	...
	public ZonedDateTime toZonedDateTime(String value) throws ValueCodecException {
		try {
			return ZonedDateTime.parse(StringEscapeUtils.unescapeJava(value));
		} 
		catch (DateTimeParseException e) {
			throw new ValueCodecException(value + " can't be decoded to the requested type", e);
		}
	...
	public File toFile(String value) throws ValueCodecException {
		return new File(StringEscapeUtils.unescapeJava(value));
	}

	@Override
	public Path toPath(String value) throws ValueCodecException {
		try {
			return Paths.get(StringEscapeUtils.unescapeJava(value));
		} 
	...
	public URI toURI(String value) throws ValueCodecException {
		try {
			return new URI(StringEscapeUtils.unescapeJava(value));
		} 
	...
	public URL toURL(String value) throws ValueCodecException {
		try {
			return new URL(StringEscapeUtils.unescapeJava(value));
		} 
	...
	public Pattern toPattern(String value) throws ValueCodecException {
		try {
			return Pattern.compile(StringEscapeUtils.unescapeJava(value));
	...
	public InetAddress toInetAddress(String value) throws ValueCodecException {
		try {
			return InetAddress.getByName(StringEscapeUtils.unescapeJava(value));
		} 
