 ...
 *
 * <p>
 * When specifying a Web server route, a header parameter can be defined as optional when the method parameter is an {@link java.util.Optional}, it is otherwise considered as required and a
 ...
 *
 * <p>
 * If a request is received containing multiple headers with the same name, the first one is bound unless the method parameter is an array, a {@link java.util.Collection}, a {@link java.util.List} or
