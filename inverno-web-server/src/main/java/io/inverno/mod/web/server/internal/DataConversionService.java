...
import io.inverno.mod.web.server.WebResponseBody.SseEncoder;
 ...
 *
 * <p>
 * It uses the list of {@link MediaTypeConverter} injected in the web server module to find the right converter to decode or encode a payload in a particular media type.
 * </p>
 *
