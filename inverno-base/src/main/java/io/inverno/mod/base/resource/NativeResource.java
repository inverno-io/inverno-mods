 ...
 * form {@code resource:path/to/resource} and looks up data in a native image.
 * </p>
 * 
 * <p>
 * A typical usage is:
...
public class NativeResource extends AbstractAsyncResource {
	 ...
	 *                                  native resource
	 */
	public NativeResource(URI uri) throws IllegalArgumentException {
		this(uri, (MediaTypeService)null);
	}
	
	/**
	 * <p>
	 * Creates a native resource with the specified URI that looks up data from the
	 ...
	 * @see Class#getModule()
	 */
	public NativeResource(URI uri, Class<?> clazz) throws IllegalArgumentException {
		this(uri, clazz, null);
	}
	
	/**
	 * <p>
	 * Creates a native resource with the specified URI that looks up data from
	 ...
	 */
	public NativeResource(URI uri, ClassLoader classLoader) throws IllegalArgumentException {
	 ...
	 *                                  native resource
	 */
	public NativeResource(URI uri, MediaTypeService mediaTypeService) throws IllegalArgumentException {
	 ...
	 *                                  native resource
	 */
	public NativeResource(URI uri, Class<?> clazz, MediaTypeService mediaTypeService) throws IllegalArgumentException {
	 ...
	 *                                  native resource
	 */
	public NativeResource(URI uri, ClassLoader classLoader, MediaTypeService mediaTypeService) throws IllegalArgumentException {
		super(mediaTypeService);
		this.uri = NativeResource.checkUri(uri);
