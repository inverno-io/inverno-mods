...
/**
 * <p>
 * A reactor defines the core threading model and more specifically it provides
 * the main event loop used at the core of Inverno's applications.
 * </p>
 * 
 * <p>
 * A reactor exposes a single acceptor event loop group used to accept
 * connection and methods to create event loop groups backed by a unique core
 * event loop group in order to optimize thread creation and usage based on
...
public interface Reactor {
	 ...
	 * 
	 * <p>
	 * This basically the maximum number of threads one can allocate to an IO event
	 * loop group.
	 * </p>
	 * 
