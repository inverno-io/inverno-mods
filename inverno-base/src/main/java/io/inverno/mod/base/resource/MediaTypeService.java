...
public interface MediaTypeService {
	 ...
	 *
	 * @return a media type or null if no known media type has been found for the specified file extension
	 */
	 ...
	 *
	 * @return a media type or null if no known media type has been found for the specified file name
	 */
	 ...
	 * @param path a path
	 *
	 * @return a media type or null if no known media type has been found for the specified path
	 */
	 ...
	 * @param uri a URI
	 *
	 * @return a media type or null if no known media type has been found for the specified URI
	 */
