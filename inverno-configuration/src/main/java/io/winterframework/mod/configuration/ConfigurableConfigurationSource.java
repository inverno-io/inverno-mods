...
/**
 * <p>
 * A configurable {@link ConfigurationSource} that supports configuration
 * properties updates.
 * </p>
 * 
 * <p>
 ...
 * @param <F> source specified update result type
 */
public interface ConfigurableConfigurationSource<A extends ConfigurationQuery<A, B, C>, B extends ExecutableConfigurationQuery<A, B, C>, C extends ConfigurationQueryResult<?,?>, D extends ConfigurationUpdate<D, E, F>, E extends ExecutableConfigurationUpdate<D, E, F>, F extends ConfigurationUpdateResult<?>> extends ConfigurationSource<A, B, C> {
	...
	/**
	 * <p>
	 * Creates a configuration update to set one configuration property in the
