 ...
 *
 * <p>
 * {@link ConfigurationLoaderSupport} implementations are generated by the Inverno configuration compiler and loads configuration properties explicitly invoking generated configurator and builder to
 ...
 * <li>Maps the resulting query results to a configurer whose role is to inject the appropriate property values in a configurator specific to the configuration to load</li>
 * <li>Invokes a configuration creator which uses the previous configurator to create the configuration</li>
 * </ol>
 *
 * <p>
...
public abstract class ConfigurationLoaderSupport<A, B, C extends ConfigurationLoaderSupport<A, B, C>> extends AbstractConfigurationLoader<A, C> {
	...
	private final Supplier<A> defaultConfigurationSupplier;
	private final String[] properties;
	private final Function<List<? extends ConfigurationQueryResult>, Consumer<B>> resultsToConfigurer;
	...
	/**
	 * <p>
	 * Creates a configuration loader that loads the specified list of properties and uses the specified results to configurer mapper and configuration creator function to create the configuration
	 * object.
	 * </p>
	 *
	 * @param properties                   a list of property names to load
	 * @param resultsToConfigurer          a mapper function that maps the configuration query results to a configurer
