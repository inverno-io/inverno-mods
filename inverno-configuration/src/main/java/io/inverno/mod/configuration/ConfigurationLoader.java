...
/**
 * <p>
 * A configuration loader is used to load a configuration object from a {@link ConfigurationSource}.
 * </p>
 *
 * <p>
 * A typical usage is:
...
public interface ConfigurationLoader<A, B extends ConfigurationLoader<A, B>> {
	 ...
	 *
	 * <p>
	 * Unlike {@link ConfigurationLoader#withConfiguration(Class)}, it is possible to load a configuration for any kind of object and not only interface since the creation of the configuration
	 * instance is delegated to the supplied configuration creator.
	 * </p>
	 *
	 * @param <E>                  the configuration type to load
	 * @param <F>                  the configurator type
	 * @param configuratorType     a class of type F
	 * @param configurationCreator a function that builds the configuration from the configurator
	 *
	 * @return a configuration loader
	 */
	 ...
	 *
	 * @throws ConfigurationLoaderException if there was an error loading the configuration
	 */
