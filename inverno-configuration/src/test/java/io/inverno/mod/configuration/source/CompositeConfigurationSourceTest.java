...
//		});
		...
		Assertions.assertEquals("datasource.url", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("node","node1"), Parameter.of("zone","US"), Parameter.of("environment","production"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/1/node1-us-production", current.get().asString().get());
		...
		Assertions.assertTrue(current.getQueryKey().getParameters().containsAll(List.of(Parameter.of("node","node1"), Parameter.of("zone","US"), Parameter.of("environment","production"))));
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("datasource.user", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().isEmpty());
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("user", current.get().asString().get());
		...
		Assertions.assertTrue(current.getQueryKey().getParameters().containsAll(List.of(Parameter.of("node","node1"), Parameter.of("zone","US"), Parameter.of("environment","production"))));
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("datasource.password", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("environment","production"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("password_prod", current.get().asString().get());
		...
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("datasource.url", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("node","node2"), Parameter.of("zone","EU"), Parameter.of("environment","production"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/2/node2-eu-production", current.get().asString().get());
		...
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("environment","production"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/1/production", current.get().asString().get());
		...
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("datasource.url", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("zone","US"), Parameter.of("environment","production"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/2/us-production", current.get().asString().get());
		...
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("datasource.url", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("environment","test"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/2/test", current.get().asString().get());
		...
		Assertions.assertEquals("datasource.url", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("environment","local"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/1/local", current.get().asString().get());
		...
		Assertions.assertTrue(current.get().getKey().getParameters().isEmpty());
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("jdbc:h2:file:/opt/1/default", current.get().asString().get());
		...
		Assertions.assertFalse(current.isPresent());
		...
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("name", current.get().getKey().getName());
		Assertions.assertTrue(current.get().getKey().getParameters().containsAll(List.of(Parameter.of("environment","test"))));
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("NameSysProp", current.get().asString().get());
	}
...
//		});
		...
		Assertions.assertTrue(current.get().getKey().getParameters().isEmpty());
		Assertions.assertTrue(current.get().isPresent());
		Assertions.assertEquals("password", current.get().asString().get());
	...
	public void testWithParameters() throws URISyntaxException {
		...
		CompositeConfigurationSource src = new CompositeConfigurationSource(List.of(src0, src2, src1)).withParameters("environment", "production", "zone", "US", "node", "node1");

		List<ConfigurationQueryResult> results = src
			.get("datasource.url", "datasource.user", "datasource.password")
			.execute()
			.collectList()
			.block();
		...
		ConfigurationQueryResult current = resultIterator.next(); // datasource.url[node=node2,zone=EU,environment=production] -> datasource.url[node=node1,environment=production,zone=US] = jdbc:h2:file:/opt/1/node1-us-production
		Assertions.assertEquals("datasource.url", current.getQueryKey().getName());
		Assertions.assertTrue(current.getQueryKey().getParameters().containsAll(List.of(Parameter.of("node","node1"), Parameter.of("zone","US"), Parameter.of("environment","production"))));
		Assertions.assertTrue(current.isPresent());
		Assertions.assertEquals("datasource.url", current.get().getKey().getName());
