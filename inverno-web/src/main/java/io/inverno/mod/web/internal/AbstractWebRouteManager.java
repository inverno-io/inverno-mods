...
/**
 * <p>
 * Base Web route manager class.
 * </p>
 * 
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.3
 * 
 * @param <A> the type of Web router
 * @param <B> the type of Web route manager
 */
abstract class AbstractWebRouteManager<A extends AbstractWebRouter, B extends AbstractWebRouteManager<A, B>> extends AbstractWebManager<B> implements WebRouteManager<ExchangeContext> {
	
	protected final A router;

	protected WebExchangeHandler<ExchangeContext> handler;

	public AbstractWebRouteManager(A router) {
		this.router = router;
	}
	...
	@Override
	public A handler(WebExchangeHandler<? super ExchangeContext> handler) {
