 ...
 */
interface ErrorAwareRouteExtractor<A extends ExchangeContext, B extends Exchange<A>, C extends Route<A, B>, D extends ErrorAwareRouteExtractor<A, B, C, D>> extends RouteExtractor<A, B, C> {
