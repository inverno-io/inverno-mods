 ...
 *
 * <p>
 * An encoded request payload is decoded using one of the {@link MediaTypeConverter} injected in the web module and corresponding to the content type of the request.
 * </p>
 *
 * <pre>{@code
