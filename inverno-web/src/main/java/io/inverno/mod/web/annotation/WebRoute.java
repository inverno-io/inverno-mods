 ...
 *
 * <p>
 * A response payload is encoded using one of the {@link MediaTypeConverter} injected in the web module and corresponding to the content type of the response which is automatically set in case of
