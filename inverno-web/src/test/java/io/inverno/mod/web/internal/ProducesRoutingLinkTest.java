...
public class ProducesRoutingLinkTest {
	...
	public void testHandle_with_default() {
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange4);
		...
		Mockito.verify(route3.getHandler(), Mockito.times(0)).handle(exchange5);
		...
		Mockito.verify(route4.getHandler(), Mockito.times(0)).handle(exchange6);
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange7);
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange9);
		...
		Mockito.verify(route3.getHandler(), Mockito.times(0)).handle(exchange10);
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange12);
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange14);
		...
		Mockito.verify(route3.getHandler(), Mockito.times(0)).handle(exchange15);
		...
		Mockito.verify(route4.getHandler(), Mockito.times(0)).handle(exchange16);
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange17);
		...
		Mockito.verify(route_default.getHandler(), Mockito.times(0)).handle(exchange19);
		...
		Mockito.verify(route3.getHandler(), Mockito.times(0)).handle(exchange20);
		...
		Mockito.verify(route4.getHandler(), Mockito.times(0)).handle(exchange21);
		...
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange22);
	...
	public void testHandle_no_default_parameters() {
		...
		MockWebExchange exchange19 = MockWebExchange.from("/").headers(Map.of(Headers.NAME_ACCEPT, List.of("*/*"))).build();
		routingLink.defer(exchange19).block();
		Mockito.verify(route5.getHandler(), Mockito.times(0)).handle(exchange19);
	...
	public void testHandle_quality_no_default() {
		...
		MockWebExchange exchange4 = MockWebExchange.from("/").headers(Map.of(Headers.NAME_ACCEPT, List.of("application/json"))).build();
		routingLink.defer(exchange4).block();
		Mockito.verify(route1.getHandler(), Mockito.times(0)).handle(exchange4);
		...
		routingLink.defer(exchange5).block();
		Mockito.verify(route2.getHandler(), Mockito.times(0)).handle(exchange5);
		...
		routingLink.defer(exchange6).block();
		Mockito.verify(route2.getHandler(), Mockito.times(0)).handle(exchange6);
		...
		Mockito.verify(route3.getHandler(), Mockito.times(0)).handle(exchange7);
