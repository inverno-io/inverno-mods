...
/**
 * <p>
 * An {@link OutboundResponseHeaders} implementation used to specify response headers in an {@link io.inverno.mod.http.client.ExchangeInterceptor}.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.8
 */
public class EndpointInterceptedResponseHeaders implements OutboundResponseHeaders {
	...
	/**
	 * <p>
	 * Creates intercepted response headers.
	 * </p>
	 * 
	 * @param headerService      the header service
	 * @param parameterConverter the parameter converter
	 */
	public EndpointInterceptedResponseHeaders(HeaderService headerService, ObjectConverter<String> parameterConverter) {
	...
	public InboundSetCookies cookies() {
		if(this.responseCookies == null) {
			this.responseCookies = new EndpointInterceptedResponseCookies(this.headerService, this.parameterConverter, this);
		}
		return this.responseCookies;
	}

	@Override
	public EndpointInterceptedResponseHeaders add(CharSequence name, CharSequence value) {
		this.underlyingHeaders.addCharSequence(name, value);
		return this;
	}

	@Override
	public <T> EndpointInterceptedResponseHeaders addParameter(CharSequence name, T value) {
	...
	@Override
	public EndpointInterceptedResponseHeaders set(CharSequence name, CharSequence value) {
		this.underlyingHeaders.setCharSequence(name, value);
		return this;
	}

	@Override
	public <T> EndpointInterceptedResponseHeaders setParameter(CharSequence name, T value) {
