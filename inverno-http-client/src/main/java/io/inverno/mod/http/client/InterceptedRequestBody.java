 ...
 * 
 * <p>
 * It is exposed in the {@link InterceptedRequest} when the request method allows it, namely {@code POST}, {@code PUT} or {@code DELETE}
 * </p>
 *
...
public interface InterceptedRequestBody {
	 ...
	 */
	InterceptedRequestBody transform(Function<Publisher<ByteBuf>, Publisher<ByteBuf>> transformer) throws IllegalStateException;
}
