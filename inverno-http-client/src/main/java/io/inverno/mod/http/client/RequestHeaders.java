...
public interface RequestHeaders {
	 ...
	 */
	RequestHeaders contentType(String contentType);
	 ...
	 * @return the response headers
	 */
	RequestHeaders contentLength(long contentLength);
	 ...
	 * @return the response headers
	 */
	RequestHeaders add(CharSequence name, CharSequence value);
	 ...
	 * @return the response headers
	 */
	RequestHeaders add(Header... headers);
	 ...
	 * @return the response headers
	 */
	RequestHeaders set(CharSequence name, CharSequence value);
	 ...
	 * @return the response headers
	 */
	RequestHeaders set(Header... headers);
	 ...
	 * @return the response headers
	 */
	RequestHeaders remove(CharSequence... names);
