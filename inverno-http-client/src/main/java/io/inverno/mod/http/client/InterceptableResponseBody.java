 ...
 * 
 * <p>
 * It is exposed in the {@link InterceptableRequest}, once the request has been sent to the endpoint and an actual response received it is no longer possible to provide a response payload and
 ...
 */
public interface InterceptableResponseBody {
	 ...
	 */
	InterceptableResponseBody.ResourceData resource();
