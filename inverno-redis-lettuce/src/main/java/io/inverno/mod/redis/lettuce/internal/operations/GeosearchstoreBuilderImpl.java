 ...
 * @param <C>
 */
public class GeosearchstoreBuilderImpl<A, B, C extends StatefulConnection<A, B>> implements RedisGeoReactiveOperations.GeosearchstoreBuilder<A, B> {
	 ...
	 * @param commands 
	 */
	public GeosearchstoreBuilderImpl(RedisGeoReactiveCommands<A, B> commands) {
	 ...
	 * @param connection 
	 */
	public GeosearchstoreBuilderImpl(Mono<StatefulRedisConnectionOperations<A, B, C, ?>> connection) {
		this.commands = null;
		this.connection = connection;
	}

	@Override
	public GeosearchstoreBuilderImpl<A, B, C> fromMember(B member) {
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> fromCoordinates(double longitude, double latitude) {
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> byRadius(double radius, RedisGeoReactiveOperations.GeoUnit unit) {
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> byBox(double width, double height, RedisGeoReactiveOperations.GeoUnit unit) {
		Objects.requireNonNull(unit, "unit");
		this.byRadius = null;
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> asc() {
		this.asc = true;
		this.desc = false;
		return this;
	}
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> desc() {
		this.asc = false;
		this.desc = true;
		return this;
	}
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> count(long count) {
		this.count = count;
		this.any = false;
		return this;
	}
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> countany(long count) {
		this.count = count;
		this.any = true;
		return this;
	}
	...
	@Override
	public GeosearchstoreBuilderImpl<A, B, C> storedist() {
		this.storeDist = true;
		return this;
	}
	 ...
	 * @return 
	 */
	private Mono<Long> build(RedisGeoReactiveCommands<A, B> localCommands, A source, A destination) {
		...
		return localCommands.geosearchstore(source, destination, geoRef, geoPredicate, this.buildGeoArgs(), this.storeDist);
	}
}
