 ...
 * @param <C>
 */
public class GeosearchExtendedBuilderImpl<A, B, C extends StatefulConnection<A, B>> implements RedisGeoReactiveOperations.GeosearchExtendedBuilder<A, B>{
	 ...
	 * @param commands 
	 */
	public GeosearchExtendedBuilderImpl(RedisGeoReactiveCommands<A, B> commands) {
	 ...
	 * @param connection 
	 */
	public GeosearchExtendedBuilderImpl(Mono<StatefulRedisConnectionOperations<A, B, C, ?>> connection) {
		this.commands = null;
		this.connection = connection;
	}

	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> fromMember(B member) {
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> fromCoordinates(double longitude, double latitude) {
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> byRadius(double radius, RedisGeoReactiveOperations.GeoUnit unit) {
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> byBox(double width, double height, RedisGeoReactiveOperations.GeoUnit unit) {
		Objects.requireNonNull(unit, "unit");
		this.byRadius = null;
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> asc() {
		this.asc = true;
		this.desc = false;
		return this;
	}
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> desc() {
		this.asc = false;
		this.desc = true;
		return this;
	}
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> count(long count) {
		this.count = count;
		this.any = false;
		return this;
	}
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> countany(long count) {
		this.count = count;
		this.any = true;
		return this;
	}
	...
	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> withcoord() {
		this.coord = true;
		return this;
	}

	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> withdist() {
		this.dist = true;
		return this;
	}

	@Override
	public GeosearchExtendedBuilderImpl<A, B, C> withhash() {
		this.hash = true;
		return this;
	}
	...
	@Override
	public Flux<RedisGeoReactiveOperations.GeoWithin<B>> build(A key) {
	 ...
	 * @return 
	 */
	private Flux<RedisGeoReactiveOperations.GeoWithin<B>> build(RedisGeoReactiveCommands<A, B> localCommands, A key) {
		...
		return localCommands.geosearch(key, geoRef, geoPredicate, this.buildGeoArgs()).map(GeoUtils::convertGeoWithin);
	}
}
