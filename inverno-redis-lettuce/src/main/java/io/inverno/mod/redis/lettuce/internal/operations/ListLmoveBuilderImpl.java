 ...
 * @param <C>
 */
public class ListLmoveBuilderImpl<A, B, C extends StatefulConnection<A, B>> implements RedisListReactiveOperations.ListLmoveBuilder<A, B> {
	 ...
	 * @param commands 
	 */
	public ListLmoveBuilderImpl(RedisListReactiveCommands<A, B> commands) {
	 ...
	 * @param connection 
	 */
	public ListLmoveBuilderImpl(Mono<StatefulRedisConnectionOperations<A, B, C, ?>> connection) {
		this.commands = null;
		this.connection = connection;
	}

	@Override
	public ListLmoveBuilderImpl<A, B, C> leftLeft() {
		this.leftLeft = true;
	...
	@Override
	public ListLmoveBuilderImpl<A, B, C> leftRight() {
		this.leftLeft = false;
		this.leftRight = true;
		this.rightLeft = false;
		this.rightRight = false;
	...
	@Override
	public ListLmoveBuilderImpl<A, B, C> rightLeft() {
		this.leftLeft = false;
		this.leftRight = false;
		this.rightLeft = true;
		this.rightRight = false;
	...
	@Override
	public ListLmoveBuilderImpl<A, B, C> rightRight() {
		this.leftLeft = false;
		this.leftRight = false;
		this.rightLeft = false;
	...
	@Override
	public Mono<B> build(A source, A destination) {
	 ...
	 * @return 
	 */
	private Mono<B> build(RedisListReactiveCommands<A, B> localCommands, A source, A destination) {
		return localCommands.lmove(source, destination, this.buildLMoveArgs());
	}
}
