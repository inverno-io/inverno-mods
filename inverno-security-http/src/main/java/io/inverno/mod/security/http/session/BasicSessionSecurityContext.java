 ...
 *
 * <p>
 * This context extends both {@link SecurityContext} and {@link BasicSessionContext}, and as such expose both session and security contexts in the application. It shall be used to support basic
 ...
 * @param <D> the authentication session data type
 */
public interface BasicSessionSecurityContext<A extends Authentication, B extends Identity, C extends AccessController, D extends AuthSessionData<A>> extends SecurityContext<B, C>, BasicSessionContext<D> {
	 ...
	 * @param <D> the authentication session data type
	 */
	interface Intercepted<A extends Authentication, B extends Identity, C extends AccessController, D extends AuthSessionData<A>> extends BasicSessionSecurityContext<A, B, C, D>, SecurityContext.Intercepted<B, C>, BasicSessionContext.Intercepted<D> {
