...
/**
 * <p>
 * Generic {@link ErrorWebServerRouterConfigurerInfo} implementation.
 * </p>
 * 
 ...
 * @see AbstractInfo
 */
public class GenericErrorWebServerRouterConfigurerInfo extends AbstractInfo<BeanQualifiedName> implements ErrorWebServerRouterConfigurerInfo {
	...
	/**
	 * <p>
	 * Creates a generic error Web server router configurer info.
	 * </p>
	 *
	 ...
	 */
	public GenericErrorWebServerRouterConfigurerInfo(TypeElement element, BeanQualifiedName name, BeanInfo bean, TypeMirror contextType) {
		super(name, bean);
