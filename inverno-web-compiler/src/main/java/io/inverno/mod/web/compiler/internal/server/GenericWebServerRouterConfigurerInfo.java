...
/**
 * <p>
 * Generic {@link WebServerRouterConfigurerInfo} implementation.
 * </p>
 * 
 ...
 * @see AbstractInfo
 */
public class GenericWebServerRouterConfigurerInfo extends AbstractInfo<BeanQualifiedName> implements WebServerRouterConfigurerInfo {
	...
	/**
	 * <p>
	 * Creates a generic Web server routes configurer info.
	 * </p>
	 *
	 * @param element     the type element of the routes configurer
	 ...
	 */
	public GenericWebServerRouterConfigurerInfo(TypeElement element, BeanQualifiedName name, BeanInfo bean, List<? extends WebServerRouteInfo> routes, TypeMirror contextType) {
		super(name, bean);
