 ...
 * @since 1.5
 */
public class JWAProcessingException extends JOSEProcessingException {
	 ...
	 */
	public JWAProcessingException(String message) {
		super(message);
	}
	 ...
	 */
	public JWAProcessingException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWAProcessingException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWAProcessingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
