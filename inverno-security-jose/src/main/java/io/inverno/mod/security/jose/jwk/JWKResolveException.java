 ...
 * @since 1.5
 */
public class JWKResolveException extends JWKProcessingException {
	 ...
	 */
	public JWKResolveException(String message) {
		super(message);
	}
	 ...
	 */
	public JWKResolveException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWKResolveException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWKResolveException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
