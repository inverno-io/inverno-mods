...
/**
 * <p>
 * Thrown by a {@link JWSReader} to indicate an error while reading a JWS.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWSReadException extends JOSEObjectReadException {
	 ...
	 */
	public JWSReadException(String message) {
		super(message);
	}
	 ...
	 */
	public JWSReadException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWSReadException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWSReadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
