...
/**
 * <p>
 * Thrown by a {@link JWACipher} to indicate an error while encrypting or decrypting data.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWACipherException extends JWAProcessingException {
	 ...
	 */
	public JWACipherException(String message) {
		super(message);
	}
	 ...
	 */
	public JWACipherException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWACipherException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWACipherException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
