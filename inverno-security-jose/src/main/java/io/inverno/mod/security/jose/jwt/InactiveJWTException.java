...
/**
 * <p>
 * Thrown by a {@link JWTClaimsSet} during validation to indicate that a JWT claim set is not active yet.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class InactiveJWTException extends InvalidJWTException {
	 ...
	 */
	public InactiveJWTException(String message) {
		super(message);
	}
	 ...
	 */
	public InactiveJWTException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public InactiveJWTException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public InactiveJWTException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
