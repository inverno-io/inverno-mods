...
/**
 * <p>
 * Thrown by a {@link JWEBuilder} to indicate an error while building a JWE.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWEBuildException extends JOSEObjectBuildException {
	 ...
	 */
	public JWEBuildException(String message) {
		super(message);
	}
	 ...
	 */
	public JWEBuildException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWEBuildException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWEBuildException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
