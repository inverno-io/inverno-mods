 ...
 * @since 1.5
 */
public class JOSEObjectReadException extends JOSEProcessingException {
	 ...
	 * </p>
	 */
	public JOSEObjectReadException() {
	}
	 ...
	 */
	public JOSEObjectReadException(String message) {
		super(message);
	}
	 ...
	 */
	public JOSEObjectReadException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JOSEObjectReadException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JOSEObjectReadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
