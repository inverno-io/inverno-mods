...
/**
 * <p>
 * Thrown by a {@link JWKGenerator} to indicate an error while generating a key.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWKGenerateException extends JWKProcessingException {
	 ...
	 */
	public JWKGenerateException(String message) {
		super(message);
	}
	 ...
	 */
	public JWKGenerateException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWKGenerateException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWKGenerateException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
