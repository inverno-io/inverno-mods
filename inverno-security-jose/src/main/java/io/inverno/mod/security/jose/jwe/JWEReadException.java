...
/**
 * <p>
 * Thrown by a {@link JWEReader} to indicate an error while reading a JWE.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWEReadException extends JOSEObjectReadException {
	 ...
	 */
	public JWEReadException(String message) {
		super(message);
	}
	 ...
	 */
	public JWEReadException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWEReadException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWEReadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
