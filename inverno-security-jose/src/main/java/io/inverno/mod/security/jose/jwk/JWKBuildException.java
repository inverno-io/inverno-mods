...
/**
 * <p>
 * Thrown by a {@link JWKBuilder} to indicate an error while building a JWK.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWKBuildException extends JWKProcessingException {
	 ...
	 */
	public JWKBuildException(String message) {
		super(message);
	}
	 ...
	 */
	public JWKBuildException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWKBuildException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWKBuildException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
