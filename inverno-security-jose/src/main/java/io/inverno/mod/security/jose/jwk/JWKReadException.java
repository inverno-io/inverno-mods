...
/**
 * <p>
 * Thrown by a {@link JWKService} to indicate an error while reading a JWK.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWKReadException extends JWKProcessingException {
	 ...
	 */
	public JWKReadException(String message) {
		super(message);
	}
	 ...
	 */
	public JWKReadException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWKReadException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWKReadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
