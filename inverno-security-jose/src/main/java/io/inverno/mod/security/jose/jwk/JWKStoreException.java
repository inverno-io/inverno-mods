...
/**
 * <p>
 * Thrown by a {@link JWKStore} to indicate an erro accessing a JWK store.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWKStoreException extends JWKProcessingException {
	 ...
	 */
	public JWKStoreException(String message) {
		super(message);
	}
	 ...
	 */
	public JWKStoreException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWKStoreException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWKStoreException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
