...
/**
 * <p>
 * Thrown by the {@link JWTService} to indicate an error while reading a JWT.
 * </p>
 *
 * @author <a href="mailto:jeremy.kuhn@inverno.io">Jeremy Kuhn</a>
 * @since 1.5
 */
public class JWTReadException extends JOSEObjectReadException {
	 ...
	 */
	public JWTReadException(String message) {
		super(message);
	}
	 ...
	 */
	public JWTReadException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWTReadException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWTReadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
