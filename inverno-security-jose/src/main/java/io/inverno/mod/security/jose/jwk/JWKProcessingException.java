 ...
 * @since 1.5
 */
public class JWKProcessingException extends JOSEProcessingException {
	 ...
	 */
	public JWKProcessingException(String message) {
		super(message);
	}
	 ...
	 */
	public JWKProcessingException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause   the cause
	 */
	public JWKProcessingException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public JWKProcessingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
